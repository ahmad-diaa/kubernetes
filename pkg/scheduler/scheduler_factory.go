...
type Configurator interface {
	...
	CreateFromProvider(providerName string) (*Scheduler, error)
	CreateFromConfig(policy schedulerapi.Policy) (*Scheduler, error)
	CreateFromKeys(predicateKeys, priorityKeys sets.String, extenders []algorithm.SchedulerExtender) (*Scheduler, error)
}
...
func (c *configFactory) Create() (*Scheduler, error) {
	return c.CreateFromProvider(factory.DefaultProvider)
}

// Creates a scheduler from the name of a registered algorithm provider.
func (c *configFactory) CreateFromProvider(providerName string) (*Scheduler, error) {
...
func (c *configFactory) CreateFromConfig(policy schedulerapi.Policy) (*Scheduler, error) {
...
func (c *configFactory) CreateFromKeys(predicateKeys, priorityKeys sets.String, extenders []algorithm.SchedulerExtender) (*Scheduler, error) {
...
func NewConfigFactory(args *factory.ConfigFactoryArgs) Configurator {
...
func (c *configFactory) GetPredicates(predicateKeys sets.String) (map[string]algorithm.FitPredicate, error) {
	...
	return factory.GetFitPredicateFunctions(predicateKeys, *pluginArgs)
}
...
func (c *configFactory) GetPriorityFunctionConfigs(priorityKeys sets.String) ([]algorithm.PriorityConfig, error) {
	...
	return factory.GetPriorityFunctionConfigs(priorityKeys, *pluginArgs)
}

func (c *configFactory) getPluginArgs() (*factory.PluginFactoryArgs, error) {
...
func (c *configFactory) getBinderFunc(extenders []algorithm.SchedulerExtender) func(pod *v1.Pod) factory.Binder {
	...
	return func(pod *v1.Pod) factory.Binder {
...
func (c *configFactory) GetPriorityMetadataProducer() (algorithm.PriorityMetadataProducer, error) {
	...
	return factory.GetPriorityMetadataProducer(*pluginArgs)
}
...
func (c *configFactory) GetPredicateMetadataProducer() (algorithm.PredicateMetadataProducer, error) {
	...
	return factory.GetPredicateMetadataProducer(*pluginArgs)
}
